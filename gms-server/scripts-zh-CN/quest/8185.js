    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (mode == 0) {
                ...
                qm.sendNextPrev("顺便说一下，你的新龙的颜色会是 #e#r随机#k#n！可能是 #g绿色，#b蓝色，#r红色，#d或者非常罕见的#k，黑色。\r\n\r\n#fUI/UIWindow.img/QuestIcon/5/0#\r\n\r 如果你不喜欢你宠物的新颜色，或者如果你想再次改变宠物的颜色，#e你可以改变它！#n 只需 #d购买另一个进化之石，10,000 金币，#k然后 #d装上你的新宠物#k 再与我对话，但是当然，我不能将你的宠物变回小龙，只能变成另一只成年龙。");
            }
        } else if (status == 2) {
...
function levelSelectPet(petId) {
    ...
    qm.sendOk("#b太棒了！#k 你的龙变得更加美丽！ #r你可以在 '现金' 背包下找到你的新宠物。\r 它曾经是 #b #i5000029##t5000029##k，现在是 \r 一个 #b#i" + newPet.getItemId() + "##t" + newPet.getItemId() + "##k！\r\n\r\n#fUI/UIWindow.img/QuestIcon/4/0#\r\n#v" + newPet.getItemId() + "# #t" + newPet.getItemId() + "#");
    qm.dispose();
}